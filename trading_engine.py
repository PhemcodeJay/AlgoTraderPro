...
class TradingEngine:
    def __init__(self, client: Optional[BybitClient] = None, trader: Optional["AutomatedTrader"] = None):
        try:
            ...
            # Inject trader later
            self.trader: "AutomatedTrader"  # tell Pylance it *will* exist
            if trader:
                self.trader = trader 
    ...
    def emergency_stop(self, reason: str = "Emergency stop triggered") -> bool:
        ...
        try:
            ...
            if open_trades and self.trader is not None:
            ...
            elif open_trades and (self.trader is None or not hasattr(self.trader, "_close_trade")):
                logger.error("Cannot close trades: trader instance is None or missing _close_trade method")
